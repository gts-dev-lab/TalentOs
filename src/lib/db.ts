...
export const {
  ...
  updateRegulation,
  deleteRegulation,
  getRegulationsForRole,
  getRegulationsForUser,
  addRegulationCompliance,
  getRegulationComplianceById,
  getComplianceForUser,
  getComplianceForRegulation,
  updateRegulationCompliance,
  deleteRegulationCompliance,
  getExpiringCompliance,
  checkUserCompliance,
  addComplianceAudit,
  getComplianceAuditById,
  getAllComplianceAudits,
  getAuditsForRegulation,
