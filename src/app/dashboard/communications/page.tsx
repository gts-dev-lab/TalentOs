...
const announcementSchema = z.object({
  ...
  type: z.enum(announcementTypes as [string, ...string[]], {
...
const announcementTemplates = [
  ...
  },
  {
    ...
    content:
      'Se informa que la plataforma estará en mantenimiento el día [Fecha] a las [Hora]. Durante este tiempo, el acceso podría ser intermitente.\n\nAgradecemos su comprensión.',
  },
  {
    ...
    content:
      'Este es un recordatorio urgente sobre [Asunto]. Es imperativo que todo el personal [Acción requerida] antes del [Fecha Límite].\n\nGracias por su cooperación.',
  },
  {
...
function AddAnnouncementDialog({
  ...
  const [generatedEmail, setGeneratedEmail] = useState<{ subject: string; body: string } | null>(
    null
  );
  ...
  const handleGenerateEmail = async () => {
    ...
    if (!isValid) {
      toast({
        title: 'Faltan datos',
        description:
          'Por favor, completa el título y el contenido del aviso antes de generar el email.',
        variant: 'destructive',
      });
      return;
    }
              ...
              <div className="space-y-4">
                <div>
                  <h4 className="font-semibold text-lg flex items-center gap-2">
                    <Mail /> Borrador de Email (IA)
                  </h4>
                  <p className="text-sm text-muted-foreground">
                    Genera un borrador de email para este anuncio, ideal para enviar por canales
                    externos.
                  </p>
                </div>
                <Button
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Button
                              ...
                              onClick={() => copyToClipboard(generatedEmail.subject, 'asunto')}
                            >
                        ...
                        <div className="space-y-2">
                          ...
                          <div className="relative">
                            ...
                            <Button
                              ...
                              onClick={() =>
                                copyToClipboard(generatedEmail.body, 'cuerpo del email')
                              }
                            >
                              <Copy className="h-4 w-4" />
                            </Button>
      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">
            Crea y gestiona las comunicaciones para la organización.
          </p>
        </div>
      ...
      <AlertDialog open={!!itemToDelete} onOpenChange={open => !open && setItemToDelete(null)}>
        ...
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. El aviso "{itemToDelete?.title}" se eliminará
              permanentemente.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
