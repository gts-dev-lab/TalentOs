    ...
    <Card className="w-full mt-8 border-primary shadow-lg">
      <CardHeader>
        <CardTitle className="text-2xl flex items-center gap-2">
          <CheckCircle className="text-green-500" /> ¡Curso Generado!
        </CardTitle>
        <CardDescription>
          Revisa la estructura del curso generada por la IA. Puedes guardarlo como borrador para
          editarlo más tarde.
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">
            Instructor: {courseData.instructor} | Duración: {courseData.duration} | Modalidad:{' '}
            {courseData.modality}
          </p>
        </div>
  ...
  const handleSaveDraft = async () => {
    ...
    try {
      const newCourseData = {
        ...
        modules: generatedCourse.modules.map((m: any, i: number) => ({
          ...m,
      ...
      toast({
        ...
        description:
          'El curso generado por IA ha sido guardado. Ahora puedes editarlo y añadir contenido.',
      });
        ...
        <div className="w-full max-w-3xl">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Describe el tema del curso que necesitas y la IA creará una estructura completa,
                incluyendo título, descripción y módulos.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <Form {...form}>
                  ...
                  <FormField
                    ...
                    render={({ field }) => (
                      <FormItem>
                        ...
                        <FormControl>
                          <Input
                            placeholder="Ej: Curso avanzado sobre manejo de hemorragias en trauma"
                            {...field}
                          />
                        </FormControl>
                        <FormMessage />
